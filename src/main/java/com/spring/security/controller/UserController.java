...
import com.spring.security.controller.dto.CreateUserDto;
...
public class UserController {
    ...
    @Transactional
    @PostMapping("/users")
    public ResponseEntity<Void> newUser(@RequestBody CreateUserDto dto) throws ResponseStatusException {
